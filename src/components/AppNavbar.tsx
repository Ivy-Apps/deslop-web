...
import { GITHUB_REPO_URL } from '@/lib/deslop';

/**
 * Two controls and a wordmark. No mobile menu — a hamburger exists to collapse
 * a list that does not fit, and this one always fits. No scroll listener and no
 * fixed positioning either: the page is short, so the header can simply scroll
 * away.
 */
