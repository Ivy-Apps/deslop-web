...
const CodeBlock = ({
  ...
  return (
    <div
      className={`bg-[#0A0A0A] border border-white/10 rounded-xl overflow-hidden font-mono text-sm ${className}`}
    >
      {filename && (
...
const BeforeAfter = ({
  ...
  return (
    <div className="space-y-4">
      {title && (
        <h4 className="text-zinc-400 text-sm font-medium uppercase tracking-wider">
          {title}
        </h4>
      )}
              ...
              <div className="relative bg-black border border-white/10 rounded-3xl p-8 shadow-2xl">
                ...
                <div className="space-y-4 font-mono text-sm">
                  ...
                  <p className="text-white">
                    Done. Your code is now Senior-grade.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-10 relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-4">
                <span className="bg-white/10 text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-widest">
                  Most Popular
                </span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-zinc-300 mb-8 leading-relaxed">
                Deslop reports errors in a LLM-friendly Markdown format with
                clear instructions on how to fix them. Perfect for integration
                with Cursor, Windsurf, or your custom MCP server.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-zinc-300 mb-8 leading-relaxed">
                ...
                top-to-bottom. High-level logic first, implementation details
                last. Clean Code compliant, automatically.
              </p>
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                ...
                <p className="text-sm text-zinc-300">
                  Our high-speed Haskell engine performs deep AST analysis to
                  ensure reordering never breaks your logic.
                </p>
              </div>
            </motion.div>
          </div>
