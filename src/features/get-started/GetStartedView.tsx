  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className={`mb-8 p-6 rounded-2xl border border-[#3E99F5]/25 bg-gradient-to-r from-[#3E99F5]/10 to-[#5C3DF5]/10`}>
          <p className="text-lg font-bold text-white mb-1">Congrats on choosing Deslop!</p>
          <p className={`${tw.text.muted}`}>
            In the AI era, agents write code faster than any human—but speed without
            guardrails is how architecture silently rots. You just made the call to
            keep your codebase intentional, consistent, and built to last. That&apos;s
            the right move.
          </p>
        </div>
        ...
        <CodeBlock code={INSTALL_COMMAND} filename="terminal" className="mb-10" />
